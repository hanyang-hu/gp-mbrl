...
ax1.set_title("Performance Comparison (Reacher-v5)")
...
ax2.set_title("Inducing Points Comparison (Reacher-v5)")
...
python train.py --seed 1 --kernel "RBF" --cfg_path "./configs/reacher.yaml" 
python train.py --seed 2 --kernel "RBF" --cfg_path "./configs/reacher.yaml"
python train.py --seed 3 --kernel "RBF" --cfg_path "./configs/reacher.yaml"
python train.py --seed 4 --kernel "RBF" --cfg_path "./configs/reacher.yaml"
python train.py --seed 5 --kernel "RBF" --cfg_path "./configs/reacher.yaml"

python train.py --seed 1 --kernel "NA" --cfg_path "./configs/reacher.yaml" 
python train.py --seed 2 --kernel "NA" --cfg_path "./configs/reacher.yaml"
python train.py --seed 3 --kernel "NA" --cfg_path "./configs/reacher.yaml"
python train.py --seed 4 --kernel "NA" --cfg_path "./configs/reacher.yaml"
python train.py --seed 5 --kernel "NA" --cfg_path "./configs/reacher.yaml"

python train.py --seed 1 --kernel "Matern" --cfg_path "./configs/reacher.yaml" 
python train.py --seed 2 --kernel "Matern" --cfg_path "./configs/reacher.yaml"
python train.py --seed 3 --kernel "Matern" --cfg_path "./configs/reacher.yaml"
python train.py --seed 4 --kernel "Matern" --cfg_path "./configs/reacher.yaml"
python train.py --seed 5 --kernel "Matern" --cfg_path "./configs/reacher.yaml"

python train.py --seed 1 --kernel "Matern" --cfg_path "./configs/reacher_dkl.yaml" 
python train.py --seed 2 --kernel "Matern" --cfg_path "./configs/reacher_dkl.yaml" 
python train.py --seed 3 --kernel "Matern" --cfg_path "./configs/reacher_dkl.yaml" 
python train.py --seed 4 --kernel "Matern" --cfg_path "./configs/reacher_dkl.yaml" 
python train.py --seed 5 --kernel "Matern" --cfg_path "./configs/reacher_dkl.yaml" 

python train.py --seed 1 --kernel "RBF" --cfg_path "./configs/reacher_dkl.yaml" 
python train.py --seed 2 --kernel "RBF" --cfg_path "./configs/reacher_dkl.yaml" 
python train.py --seed 3 --kernel "RBF" --cfg_path "./configs/reacher_dkl.yaml" 
python train.py --seed 4 --kernel "RBF" --cfg_path "./configs/reacher_dkl.yaml" 
python train.py --seed 5 --kernel "RBF" --cfg_path "./configs/reacher_dkl.yaml" 

python train.py --seed 1 --kernel "SM" --cfg_path "./configs/reacher_dkl.yaml" 
python train.py --seed 2 --kernel "SM" --cfg_path "./configs/reacher_dkl.yaml" 
python train.py --seed 3 --kernel "SM" --cfg_path "./configs/reacher_dkl.yaml" 
python train.py --seed 4 --kernel "SM" --cfg_path "./configs/reacher_dkl.yaml" 
python train.py --seed 5 --kernel "SM" --cfg_path "./configs/reacher_dkl.yaml" 
